...
namespace fcitx {
    ...
    FCITX_CONFIGURATION(
        ...
        Option<bool>                                           showToggleSpellCheck{this, "ShowToggleSpellCheck", "", true};
        Option<bool>                                              showToggleMacro{this, "ShowToggleMacro", "", true};
        Option<bool>                                       showToggleAutoRestore{this, "ShowToggleAutoRestore", "", true};
        Option<bool>                                     showToggleFixStickyShift{this, "ShowToggleFixStickyShift", "", true};
        Option<bool>                                        showToggleDictionary{this, "ShowToggleDictionary", "", true};
        Option<bool>                                     showToggleCapitalizeMacro{this, "ShowToggleCapitalizeMacro", "", true};
        Option<bool>                                         showToggleModernStyle{this, "ShowToggleModernStyle", "", true};
        Option<bool>                                           showToggleFreeMarking{this, "ShowToggleFreeMarking", "", true};
        Option<bool>                                          showToggleDoubleSpace{this, "ShowToggleDoubleSpace", "", true};
        ...
        Option<std::string> quickToggleOrder{this, "QuickToggleOrder", _("Quick Toggle Order"),
                                             "SpellCheck,Macro,AutoRestore,FixStickyShift,CustomDictionary,CapitalizeMacro,ModernStyle,FreeMarking,DoubleSpace"};
