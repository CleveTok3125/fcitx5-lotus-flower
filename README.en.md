...
- Added Quick Toggle Menu: hotkey to quickly toggle input options, with customizable shortcuts and menu order.
...
- **Individual `AutoNonVnRestoreKey` and `MacroToggleKey` hotkeys** — replaced by Quick Toggle Menu.
